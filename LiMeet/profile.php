        ...
        <div class="col-md-3 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
             ...
             ?>
                ...
                <span class="font-weight-bold"><?php echo $user_data['FirstName']; ?></span><span class="text-black-50"><?php echo $user_data['Email']; ?></span><span> </span></div>
        ...
        <div class="col-md-5 border-right">
            <form action="profile.php" method="POST">
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-6"><label class="labels">Name</label><input type="text" class="form-control" id="firstname" placeholder="first name" value= <?php echo $user_data['FirstName']; ?>></div>
                        <div class="col-md-6"><label class="labels">Surname</label><input type="text" class="form-control" id="lastname" placeholder="surname" value= <?php echo $user_data['LastName']; ?>></div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-12"><label class="labels">Age</label><input type="number" class="form-control" placeholder="enter your age" id="age" value= <?php echo $user_data['Age']; ?>></div>
                        <div class="col-md-12"><label class="labels">Nationality</label>
                            <select class="form-select" id="nationality" required>
                                <?php 
                                    foreach ($nationality as $key => $value) {
                                        if ($user_data['Nationality'] === $value) {
                        ...
                        <div class="col-md-12"><label class="labels">Email ID</label><input type="text" class="form-control"id="email" placeholder="enter email id" value=<?php echo $user_data['Email']; ?>></div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-6"><label class="labels">Gender</label>
                            <select class="form-select" id="gender" required>
                                <option value="Gender">Gender</option>
                                <option value="Male" <?php if ($user_data['Gender'] === "Male") {print "selected";} ?>>Male</option>
                                <option value="Female" <?php if ($user_data['Gender'] === "Female") {print "selected";} ?>>Female</option>
                                <option value="Other" <?php if ($user_data['Gender'] === "Other") {print "selected";} ?>>Other</option>
                            </select>
                        </div>
                        <div class="col-md-6"><label class="labels">Seeking</label>
                            <select class="form-select" id="seeking" required>
                                <option value="Seeking">Seeking</option>
                                <option value="Male"<?php if ($user_data['Seeking'] === "Male") {print "selected";} ?>>Male</option>
                                <option value ="Female" <?php if ($user_data['Seeking'] === "Female") {print "selected";} ?>>Female</option>
                                <option value="Other" <?php if ($user_data['Seeking'] === "Other") {print "selected";} ?>>Other</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <textarea id="description" class="md-textarea form-control" rows="3"><?php echo $user_data['Description']; ?></textarea>
                        </div>
                    </div>
